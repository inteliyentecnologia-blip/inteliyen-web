    ...
    <div className="min-h-screen bg-black text-white pb-20">
      <div className="max-w-5xl mx-auto px-6 pt-24">
        ...
        <div className="bg-[#0A0E17] border border-gray-800 p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden">
          ...
          <a href="https://wa.me/523314494403" target="_blank" className="inline-block bg-gradient-to-r from-purple-600 to-cyan-500 px-12 py-5 rounded-full font-extrabold text-lg shadow-[0_0_20px_rgba(168,85,247,0.4)]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {course.modules.map((m, i) => {
            const parts = m.split('\n•');
            return (
              <div key={i} className="bg-[#0A0E17] border border-gray-800 p-10 rounded-[2rem]">
                <h3 className="text-2xl font-bold text-cyan-400 mb-6">{parts[0]}</h3>
        ...
        <div className="mt-20 bg-[#0A0E17] border border-yellow-500/20 p-12 rounded-[2.5rem] flex flex-col md:flex-row items-center gap-12 shadow-2xl">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-400 text-lg leading-relaxed">
              Al concluir con éxito este programa, obtendrás un diploma avalado por CERTIVALI con valor curricular formal a nivel internacional.
            </p>
          </div>
        </div>
      </div>
