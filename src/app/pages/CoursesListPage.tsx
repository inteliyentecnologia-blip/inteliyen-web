...
// CORRECCIÓN: Link debe importarse desde react-router-dom
import { Link } from 'react-router-dom';
import { ArrowLeft, BookOpen, Clock, TrendingUp, ChevronRight } from 'lucide-react';
// La ruta a tus datos es correcta según tu estructura
      ...
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Validación defensiva: Solo mapear si courses existe y es un arreglo */}
            {courses && courses.length > 0 ? (
              ...
              <div className="col-span-full text-center py-10">
                <p className="text-xl text-gray-400">Cargando cursos o no hay cursos disponibles en este momento.</p>
              </div>
            )}
          </div>
          ...
          >
            <div className="relative group inline-block">
              ...
              <div className="relative bg-black/80 backdrop-blur-xl border border-purple-500/20 rounded-2xl p-8 md:p-12">
                ...
                <Link
                  to="/#contact" // Mejor forma de enlazar a un ancla
